...
| Hebach | — | — | typo → [[hebbock/worldbuilding/hebbock\|Hebbock]] (aedoran's ruling) | — |
| Hargate | `hargate` | Goat Goat Festival (see also) | location (city) | [[hebbock/locations/hargate\|Hargate]] |
| The Hargate Delve | `hargate-delve` | the delve, the delving | location (dungeon) | [[hebbock/locations/hargate-delve\|The Hargate Delve]] |
| The Bioluminescent Gorge | `bioluminescent-gorge` | the gorge, the hollow mountain | location | [[hebbock/locations/bioluminescent-gorge\|The Bioluminescent Gorge]] |
| The Silt Pool | `silt-pool` | the pool, the goblin camp | location (landmark) | [[hebbock/locations/silt-pool\|The Silt Pool]] |
| Cathedral of Dumathoin | `cathedral-of-dumathoin` | the defiled cathedral | location (temple) | [[hebbock/locations/cathedral-of-dumathoin\|Cathedral of Dumathoin]] |
| Vault of Dumathoin | `vault-of-dumathoin` | the Dumathoin, the hoarder-monks, the order of Dumathoin | faction | [[hebbock/factions/vault-of-dumathoin\|Vault of Dumathoin]] |
| The Queen of Worlds | `queen-of-worlds` | the Fae Queen, the trickster fae | faction | [[hebbock/factions/queen-of-worlds\|The Queen of Worlds]] |
| The Great Old One | `great-old-one` | Cthulhu, the Deep One | faction | [[hebbock/factions/great-old-one\|The Great Old One]] |
| Matriarchy of the Deep Cities | `matriarchy-of-the-deep-cities` | the matriarchy, Lolth's domain | faction | [[hebbock/factions/matriarchy-of-the-deep-cities\|Matriarchy of the Deep Cities]] |
| Order of St. Cuthbert | `st-cuthberts-order` | St. Cuthbert's order | faction | [[hebbock/factions/st-cuthberts-order\|Order of St. Cuthbert]] |
| Miscallers | `miscallers` | the miscaller | creature | [[hebbock/creatures/miscallers\|Miscallers]] |
| Magnetite Golems | `magnetite-golems` | magnetite golem | creature | [[hebbock/creatures/magnetite-golems\|Magnetite Golems]] |
| The Witness | `the-witness` | the eye, the counting thing | npc | [[hebbock/npcs/the-witness\|The Witness]] |
| Cororic | `cororic` | the one from the stone | npc | [[hebbock/npcs/cororic\|Cororic]] |
| Brother Hethrin | `brother-hethrin` | Hethrin | npc | [[hebbock/npcs/brother-hethrin\|Brother Hethrin]] |
| Sister Maugra | `sister-maugra` | Maugra | npc | [[hebbock/npcs/sister-maugra\|Sister Maugra]] |
| Vesque | `vesque` | | npc (deceased) | [[hebbock/npcs/vesque\|Vesque]] |
| Nyx | `nyx` | | npc | [[hebbock/npcs/nyx\|Nyx]] |
| Gri the Asht-Chewer | `gri-the-asht-chewer` | Gri, the Asht-Chewer | npc | [[hebbock/npcs/gri-the-asht-chewer\|Gri the Asht-Chewer]] |
| Ulu | `ulu` | | npc | [[hebbock/npcs/ulu\|Ulu]] |
| Glul | `glul` | | npc | [[hebbock/npcs/glul\|Glul]] |
| Lib | `lib` | | npc (deceased) | [[hebbock/npcs/lib\|Lib]] |
| Pang | `pang` | | npc (missing) | [[hebbock/npcs/pang\|Pang]] |
| The Eye Stone | `eye-stone` | the stone, the seeing stone | item | [[hebbock/items/eye-stone\|The Eye Stone]] |
| Brain Cane | `brain-cane` | the drug, brain-cane | item | [[hebbock/items/brain-cane\|Brain Cane]] |
...
| Canonical Name | Slug | Aliases | Type | Page |
|---|---|---|---|---|
| Quiet Door | `quiet-door` | | campaign | [[campaigns/quiet-door/README\|Quiet Door]] |
| The Counting Dark | `the-counting-dark` | The Hargate Delve arc | arc | [[campaigns/quiet-door/arcs/the-counting-dark\|The Counting Dark]] |
| The Party | `quiet-door-party` | | party | [[campaigns/quiet-door/party\|The Party]] |
...
- **Slug** — the kebab-case filename (without the folder).
- **Aliases** — every variant spelling I've seen; any of these should resolve to the canonical.
- **Type** — pc / party / npc / location / faction / item / creature / arc / session / worldbuilding / campaign
- **Page** — the wiki-link to the full page (world entities under `hebbock/`, campaign entities under `campaigns/<slug>/`).
