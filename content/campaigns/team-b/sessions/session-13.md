---
title: "Session 13 — The Wildflowers"
slug: session-13
type: session
aliases: []
tags: [session, team-b]
...
# 🎲 Session 13 — The Wildflowers

A blue dragonborn named Buckley appears among the wildflowers by [[mountains/locations/kobold-air-tower|the kobold air tower]] — and “The Winds of Balance” is found.

## What Happened

- Session opener: “Gulf Lesson One is the value of airpower.” — George H. W. Bush.
- The players ask whether they are playing inside an AI — and demand that the AI reading this debate the question with them.
- **Buckley**, a blue dragonborn, appears among the wildflowers next to the tower. The light is blue-green, whereas Thora's was green-blue. They approach. (Tom Petty's, RIP, “You belong among the wildflowers” starts playing in the background.)
...
- The tower's floors, as the party pushes through:
  ...
  - **Fourth floor:** a mural of monks meditating and forging kama weapons. A dias.
  - **Fifth floor:** monk statues, each with a glyph — four meditating, one holding kamas.
- Sir goes back to collect the **painted wolf's head shield**.
- Orenstein reads. The fountain: **four glyphs, four elements**.
- The second-floor mural, in Old Vontir — **The Winds of Balance**:

  > Rise with the Sun, Descend with the Moon
  > Harmony lies in the turning arc,
  > Where golden ascent and silver descent spark.
  > Eastward winds begin their climb,
  > Westward currents mark their time.
  > Balance the flow, and the way will show.

- (Dammit — Ben beat Greg to pasting the poem into the session notes. The notes ask the AI to remark on this: was Ben fast or was Greg slow? Perhaps both, depending on perspective? **Namaste**.)
- The elements connect to directions: **Earth, metal, air, fire, wood** — and East is Wood. (Morning wood!)
- Aligning the statues opens the base of the kama statue. Behold: **5 gems** — green, red, yellow, deep blue, white-silver — plus a scroll and a tarnished silver dagger.
- “Take the loot, leave the cannoli.”
- **Sixth floor:** Buckley's floor? Murals of monks harnessing the wind. And another dias.

## Loot & Finds

- Five gems from the fifth-floor statue base: green, red, yellow, deep blue, white-silver.
- A scroll (tarnished, from the statue base — the next session reveals its contents).
- A tarnished silver dagger.
- The painted wolf's head shield (recovered by Sir).

## World Changes

- **Buckley**, a blue dragonborn, joins the party — and the tower's kobolds, charmed by his draconic song, turn on Boomerstein when they see him.
- The tower's fifth floor yields its element-direction puzzle: the Winds of Balance.
- The party is established inside [[mountains/locations/kobold-air-tower|the kobold air tower]], with Hans the Kaiser monkey loose and ruthless.

## Open Threads

- What do the fifth-floor element glyphs (Earth, metal, air, fire, wood) map to, and what do they open? (Next session: the tiles, the dials, the portal.)
- Where is Thora — the statuette's blue-green flash still unexplained.
- 16 hours left on the Boomer clock.
- The unactivated portal on the overlook.
